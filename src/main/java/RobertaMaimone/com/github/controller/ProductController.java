...
public class ProductController {
    ...
    public ResponseEntity<ProductEntity> newProduct(@RequestBody ProductEntity productEntity) throws ProductAlreadyRegisteredException {
    ...
    public ResponseEntity<ProductDTO> searchByProduct(@PathVariable String id) throws ProductNotFoundException {
